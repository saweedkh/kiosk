      ...
      <Controller
        ...
        render={({ field }) => (
          <Switch
            ...
            onChange={field.onChange}
            label="اعمال هزینه سرویس و بسته‌بندی"
          />
        )}
      />
      <p className="text-sm text-gray-500 dark:text-gray-400 -mt-4">
        اگر فعال باشد و حداقل یک محصول از این نوع در سبد باشد، هزینه سرویس و بسته‌بندی همان نوع سفارش فقط یک‌بار به فاکتور اضافه می‌شود — حتی اگر چند محصول تیک‌دار در سبد باشد.
      </p>
